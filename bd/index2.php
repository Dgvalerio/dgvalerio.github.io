...
<div id="content">
    ...
    <div class="container" align="center">
        ...
        <div id="" class="">
            <form class="form-custom plBG9" method="post" action="confirma.php">
                <div id="pnFormulario" class="">
                    ...
                    <div class="" id="pnBd00">
                        ...
                        <button id="ini" class="btn btn-primary btn-block btn-lg" type="button" onclick="toPage(10)"> Iniciar aplicação  </button>
                        <button id="ini" class="btn btn-primary btn-block btn-lg" type="button"> Acessar base de dados </button>
                        <button id="ini" class="btn btn-primary btn-block btn-lg collapse mst" type="button"> Gerenciar usuários </button>
                    </div> <br/>
                </div>
            </form> <br/>
        </div>
