...
$vuser	= isset ($_GET ["c_user"])? $_GET ["c_user"]:'';
?>
...
<script>
    function apagarUsuario(idd){
        $("#d_envia").val(idd);
        document.deleteUsuario.submit();
    }
</script>
...
<div id="content">
    <div class="container" align="center">
        ...
        <br/> <div class="result-custom pC9 crPreta" id="pnResposta">
            <form name="deleteUsuario" id="deleteUsuario" action="del.php">
...
<th class='col-md-1 cntr' scope='row'>$exibe[id]</th> 
<td class='col-md-4'>$exibe[nome]</td> 
<td class='col-md-3'>$exibe[usuario]</td> 
<td class='col-md-3'>$exibe[dat]</td>
<th align='center' class='col-md-1 glyphicons' onclick='apagarUsuario($exibe[id])'><div class='glyphicons-17-bin'></div></th>
                </tr> ";
                } echo"</tbody> </table>";
                mysqli_close($link);
                ?>
